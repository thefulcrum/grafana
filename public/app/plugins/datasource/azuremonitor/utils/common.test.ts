<<<<<<< HEAD:public/app/plugins/datasource/grafana-azure-monitor-datasource/utils/common.test.ts
...
>>>>>>> v12.1.0:public/app/plugins/datasource/azuremonitor/utils/common.test.ts
