...
export const Selector = ({ refId, query, templateVariableOptions, onChange, datasource }: Props) => {
  return (
    <EditorField label="Selector" htmlFor={`${refId}-slo-selector`}>
      <Select
<<<<<<< HEAD:public/app/plugins/datasource/cloud-monitoring/components/SLO/Selector.tsx
        menuShouldPortal
        width={SELECT_WIDTH}
=======
        inputId={`${refId}-slo-selector`}
        width="auto"
>>>>>>> v12.1.0:public/app/plugins/datasource/cloud-monitoring/components/Selector.tsx
        allowCustomValue
