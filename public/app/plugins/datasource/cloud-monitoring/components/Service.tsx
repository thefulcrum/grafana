...
export const Service = ({ refId, query, templateVariableOptions, onChange, datasource }: Props) => {
  ...
  return (
    <EditorField label="Service">
      <Select
<<<<<<< HEAD:public/app/plugins/datasource/cloud-monitoring/components/SLO/Service.tsx
        menuShouldPortal
        width={SELECT_WIDTH}
=======
        inputId={`${refId}-slo-service`}
        width="auto"
>>>>>>> v12.1.0:public/app/plugins/datasource/cloud-monitoring/components/Service.tsx
        allowCustomValue
