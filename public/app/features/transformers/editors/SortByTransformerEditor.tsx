      ...
      {sorts.map((s, index) => {
        return (
          <InlineFieldRow key={`${s.field}/${index}`}>
            ...
            >
              <Select
<<<<<<< HEAD:public/app/core/components/TransformersUI/SortByTransformerEditor.tsx
                menuShouldPortal
                options={fieldNames}
=======
                options={[...fieldNames, ...variables]}
>>>>>>> v12.1.0:public/app/features/transformers/editors/SortByTransformerEditor.tsx
                value={s.field}
